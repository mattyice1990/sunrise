      ...
      <div className="container owner__grid">
        <div className="owner__media">
          ...
          <div className="owner__photo">
            <Slot id="owner-eddie" src="uploads/roof-installation-tucson.jpg" ph="Eddie on a roof" alt="Eddie Guillen, owner of Sunrise Roofers, working on a roof in Tucson, AZ" />
          </div>
        </div>
