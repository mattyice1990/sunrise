...
function botReply(text) {
  ...
  if (/(metal|tile|shingle|flat|coating)/.test(t)) return "Great choice — we install and repair that system across Tucson. What's the approximate age and size of your roof?";
