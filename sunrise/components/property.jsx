...
const PROP_DATA = [
  { ic: "home", t: "Homeowners", h: "Protect Your Home & Your Budget",
    ...
    b: ["Free, fully-documented roof inspections", "Repair-first guidance to avoid premature replacement", "Energy-efficient metal & tile upgrades for AZ heat", "Flexible financing on approved credit"], slot: "prop-home", src: "uploads/residential-roofing-tucson-aerial.jpg" },
  { ic: "users", t: "HOAs & Property Managers", h: "Roofing That Keeps Boards & Residents Happy",
    ...
    b: ["Phased scheduling across multiple units", "Detailed service logs & condition reports", "Budget planning & reserve-study support", "Proactive maintenance to extend roof life"], slot: "prop-hoa", src: "uploads/hoa-roofing-tucson.webp" },
  { ic: "building", t: "Commercial Buildings", h: "Low-Disruption Commercial Roofing",
    ...
    b: ["Flat-roof coatings & restoration vs. tear-off", "Leak prevention & drainage correction", "Scheduled maintenance programs", "Emergency response for active leaks"], slot: "prop-comm", src: "uploads/commercial-roofing-tucson-aerial.jpg" },
  { ic: "factory", t: "Multi-Family Communities", h: "Safe, Phased Roofing for Residents",
    ...
    b: ["Phased roofing to keep units occupied", "Tenant-safety planning & site protection", "Rapid monsoon-damage response", "Preventative maintenance contracts"], slot: "prop-multi", src: "uploads/multifamily-roofing-tucson.jpg" },
  { ic: "store", t: "Retail Centers & Plazas", h: "Keep Every Storefront Open",
    ...
    b: ["Work staged to keep stores open", "Minimized noise & disruption windows", "Drainage & ponding-water solutions", "Fast leak response for tenants"], slot: "prop-retail", src: "uploads/retail-roof-coating-tucson.jpg" },
  { ic: "truck", t: "New Construction", h: "Clean Roofing Handoffs for Builders",
    ...
    b: ["On-time coordination with the build schedule", "Plan & material spec coordination", "Inspections & code compliance", "Clean handoff & warranty documentation"], slot: "prop-new", src: "uploads/new-construction-roofing-tucson.webp" },
];
...
function PropertyTypeSection() {
  ...
  return (
    <section className="section dark prop-sec" id="property">
      <div className="prop-sec__bg" style={{ backgroundImage: "url('uploads/tile-roof-replacement-marana.jpg')" }} aria-hidden="true"></div>
